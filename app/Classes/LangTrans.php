...
class LangTrans
{
    public static $mainTranslations = [
        ...
        'sales' => [
            ...
            'action' => 'Action',
            'sale_snapshot' => 'Sale Snapshot',
            'enrolled' => 'Enrolled',
            'settled_debt_average' => 'Settled Debt Average',
            'debt' => 'Debt',
            'plan' => 'Plan',
            'length' => 'Length',
            ...
            'campaign' => 'Campaign',
            'contact' => 'Contact',
            'are_you_want_to_resume_this_sale' => 'Are you sure you want to resume this sale?',
            'transfer' => 'Transfer',
            'transfer_sales' => 'Transfer Sales',
            'transfer_sales_to' => 'Transfer {0} Sales To:',
            'transfer_sales_message' => 'Are you sure you want to transfer the selected sales to {0}?',
            'transfer_sales_success' => 'Sales transferred successfully',
            'unassigned' => 'Unassigned',
            'view_only_unassigned' => 'View Only Unassigned',
            'selected_delete_message' => 'Are you sure you want to delete selected sale?',
        ],
        'lead' => [
            'add' => 'Add New Lead',
            'edit' => 'Edit Lead',
            ...
            'notes_timeline_message_updated' => 'Notes updated by {0} on {1}',
            'notes_timeline_message_deleted' => 'Notes deleted by {0} on {1}',
            'lead_timeline_message_updated' => 'Lead updated by {0} on {1}',
            'co_timeline_message_updated' => 'Co-Applicant updated by {0} on {1}',
            'lead_address_timeline_message' => 'Lead address added by {0} on {1}',
            'lead_address_timeline_message_updated' => 'Lead address updated by {0} on {1}',
            'co_address_timeline_message' => 'Co-Applicant address added by {0} on {1}',
            'co_address_timeline_message_updated' => 'Co-Applicant address updated by {0} on {1}',
            'co_timeline_message' => 'Co-Applicant added by {0} on {1}',
            ...
            'applicant_saved_successfully' => 'Applicant Details saved successfully',
            'joint' => 'Joint',
