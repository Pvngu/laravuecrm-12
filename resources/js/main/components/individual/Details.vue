    ...
    >
        <a-form layout="vertical" class="mt-20">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                ...
                class="hidden-label"
                >
                <a-input v-model:value="coApplicantFormData.co_first_name" :placeholder="$t('common.placeholder_default_text', [$t('lead.first_name')])"></a-input>
                </a-form-item>
            </a-col>
            </a-row>
            <a-row :gutter="16">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                ...
                class="hidden-label"
                >
                <a-input v-model:value="coApplicantFormData.co_last_name" :placeholder="$t('common.placeholder_default_text', [$t('lead.last_name')])"></a-input>
                </a-form-item>
            </a-col>
            </a-row>
            <a-row :gutter="16">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                ...
                class="hidden-label"
                >
                <a-input v-model:value="coApplicantFormData.co_SSN" :placeholder="$t('common.placeholder_default_text', [$t('lead.SSN')])"></a-input>
                </a-form-item>
            </a-col>
            </a-row>
            <a-row :gutter="16">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                ...
                <DateTimePicker
                    ...
                    :showTime="false"
                    :onlyDate="true"
                    @dateTimeChanged="(changedDateTime) => (coApplicantFormData.co_date_of_birth = changedDateTime)"
                />
                </a-form-item>
            </a-col>
            </a-row>
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                ...
                class="hidden-label"
                >
                <a-input v-model:value="coApplicantFormData.co_home_phone" :placeholder="$t('common.placeholder_default_text', [$t('lead.home_phone')])"></a-input>
                </a-form-item>
            </a-col>
            </a-row>
            <a-row :gutter="16">
            ...
            <a-col :xs="24" :sm="24" :md="12" :lg="12">
                ...
                class="hidden-label"
                >
                <a-input v-model:value="coApplicantFormData.co_phone_number" :placeholder="$t('common.placeholder_default_text', [$t('lead.phone_number')])"></a-input>
                </a-form-item>
            </a-col>
            </a-row>
            <a-row :gutter="16">
